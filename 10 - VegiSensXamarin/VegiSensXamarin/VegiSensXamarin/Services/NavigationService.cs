...
namespace VegiSensXamarin.Services
{
    public class NavigationService : INavigationService
    {
        ...
        private ContentPage GetPage(string pageName, object objectToPass = null)
        {
            switch (pageName)
            {
                case PageUrls.VegetableMenuView: return new GroentenMenu();
                case PageUrls.VegetableDetailView: return new GroentenDetail();
            }
            return null;
        }
        ...
        public Task PushModalAsync(object menuView)
        {
            throw new NotImplementedException();
        }
    }
